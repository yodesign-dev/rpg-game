  ...
  return (
    <>
      <button
        ...
        aria-label="Cài đặt"
        className="w-11 h-11 rounded-full bg-white/[0.06] border border-white/10
          flex items-center justify-center hover:bg-white/[0.1] transition-colors"
      >
        <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="#b9b3c4" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
